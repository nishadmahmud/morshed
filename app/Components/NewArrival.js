...
const NewArrival = () => {
    ...
    return (
        <div className="my-12 md:w-10/12 w-11/12 mx-auto">
          ...
          <p className='text-center md:w-7/12 mx-auto text-gray-800'> Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the  standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled </p>
            <div>
