              ...
              {isLoading ? (
                ...
                bestDeals.data.slice(0, 10).map((product) => {
                  ...
                  return (
                    <div
                      key={product.id}
                      className="bg-white border border-gray-300 rounded-xl flex flex-col shadow-sm hover:scale-105 transition py-2"
                    >
                      <Link
                      ...
                      >
                        ...
                        <div className="mt-6 px-4 my-2">
                          <h3 className="text-sm font-semibold text-black line-clamp-1 mt-3 text-start">
                            {product.name}
                          </h3>
                          <div>
                            {product.discount ? (
                              <div className="flex gap-2 items-start justify-start">
                                ...
                                <span className="text-xs md:text-sm font-bold text-gray-500 line-through">
                                  <span className="font-bangla text-xs md:text-xl">
                                    ৳
                                  </span>
                                  {product.retails_price}
                                </span>
