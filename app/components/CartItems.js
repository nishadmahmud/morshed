...
const CartItems = () => {
  ...
  return (
    <div
      className={`fixed top-0 right-0 lg:w-96 w-72 h-full bg-white shadow-lg z-50 p-4 transition-transform duration-300 ease-in-out transform ${isVisible ? 'translate-x-0' : 'translate-x-full'}`}
    >
      {
        items.length > 0 ? <>
          <div
