...
// export default async function Home() {
//   const response = await fetch(`${process.env.NEXT_PUBLIC_API}/public/categories/${userId}`,{ next: { revalidate: 300 } });
//   const data = await response.json();
...
//   const res = await fetch(`${process.env.NEXT_PUBLIC_API}/get-sliders/${userId}`,{ next: { revalidate: 300 } });
//   const slider = await res.json();

//   const bannerRes = await fetch(`${process.env.NEXT_PUBLIC_API}/get-banners/${userId}`,{ next: { revalidate: 300 } })
//   const banner = await bannerRes.json();

//   const categoriesRes = await fetch(`${process.env.NEXT_PUBLIC_API}/public/categories/${userId}`,{ next: { revalidate: 300 } });
//   const categories = await categoriesRes.json();



//   const brandsRes = await fetch(`${process.env.NEXT_PUBLIC_API}/public/brands/${userId}`,{ next: { revalidate: 300 } });
//   const brands = await brandsRes.json();
