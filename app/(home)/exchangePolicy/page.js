...
const Page = () => {
  return (
    <div className="bg-white lg:pt-40 lg:px-12 text-center p-8 rounded-lg  mx-auto">
      <h1 className="text-3xl font-bold text-center text-gray-800 mb-6">Exchange Policy</h1>
      
      <p className="text-lg text-gray-700 mb-4">
        At <span className="font-semibold">[Your Mobile Shop]</span>, we want you to be completely satisfied with your purchase.
      ...
      <div className="mb-6">
        ...
        <ol className="list-decimal list-inside text-gray-700 text-lg">
          <li>Contact our customer support team at <span className="font-semibold">support@[yourshop].com</span>.</li>
      ...
      <div className="mb-6">
        ...
        <ul className="list-disc list-inside text-gray-700 text-lg">
          ...
          <li>Opened or used accessories (e.g., phone cases, chargers) are non-returnable.</li>
        </ul>
      </div>
