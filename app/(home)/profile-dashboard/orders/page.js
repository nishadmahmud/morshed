      ...
      <div className="bg-white text-black p-4 md:p-6 shadow-md rounded-lg">
        ...
        <div className="flex justify-start space-x-1 md:space-x-2 border-b border-gray-300 overflow-x-auto pb-2">
          {tabs.map((tab) => (
            ...
            >
              ...
              {activeTab === tab.type && (
                <div
                  className="absolute left-0 right-0 bottom-0 h-1 bg-[#115e59] transition-all duration-300"
                />
              )}
            </button>
          ))}
        ...
        <div className="mt-4">
          {loading ? (
            ...
            <div
              className="text-center text-red-500 py-8 animate-fade-in"
            >
              <p>{error}</p>
              <button
                      ...
                      <div className="bg-gray-50 p-4 flex flex-col md:flex-row md:justify-between md:items-center gap-2 border-b">
                        <div>
                          <div className="flex items-center gap-2">
                            ...
                            <span
                              className={`text-xs px-2 py-0.5 rounded-full ${getStatusBadge(order.tran_status).color
                                }`}
                            >
